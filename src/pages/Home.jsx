...
const Home = () => {
  ...
  >
      ...
      <br></br>
      <h3>
        You'll find everything you'll need here; check-out procedures, simple house rules, eating recommendations, transportation information, and emergency numbers for maintenance issues. For anything that this site doesn't answer for you, please contact us via the Airbnb or the VRBO app.
      </h3>
      <Footer/>
  </Grid>
  )
